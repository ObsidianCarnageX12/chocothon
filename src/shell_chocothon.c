...
/*
Sunday, August 5, 2018 21:56 PM
   Added some basic SDL Initialization Code into this file at Heap Initializtion and Main Loop!
-Obsidian
...
//#include <appleevents.h> //We definately dont need nor have access to this so it will need replacement or clearance
#include <aliases.h>
#include "SDL.h"
...
void InitializeSDL()
{
	//If SDL Fails to initialize then print error to log file and force the app to close!
	...
	void)
{
	...
	InitializeSDL(); // Call This to Initialize SDL as early as possible!
